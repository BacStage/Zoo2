...
namespace Crud_App.Navigation
{
    partial class UebersichtSeite
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.zooDataSet = new Crud_App.ZooDataSet();
            this.mitarbeiterBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.mitarbeiterTableAdapter = new Crud_App.ZooDataSetTableAdapters.MitarbeiterTableAdapter();
            ...
            this.mitarbeiterBindingSource.DataSource = this.zooDataSet;
            // 
        ...
        private ZooDataSetTableAdapters.MitarbeiterTableAdapter mitarbeiterTableAdapter;
    }
}
